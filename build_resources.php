<?php
  ...
  $tileImageFilenameToTileImageIndex = array(
    'tiles3.png'          => 'tiles',
    'tiles-old.png'       => 'tiles-old',
    'overworld-tiles.png' => 'overworld-tiles',
  );
  ...
  foreach ($DATA['textures'] as $textureName => $texture) {
    ...
    foreach ($texture['characters'] as $characterName => $character) {
      ...
      if (@$R['animationGroups'][$characterName]) { die("Resource sprites/data.json - character name conflict: $characterName"); }
  ...
  foreach (glob('maps/*.tmx') as $mapFile) {
    ...
    $area = array(
      'image'      => $tileImageFilenameToTileImageIndex[$imageFilename],
