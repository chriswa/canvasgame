...
function build_sprites() {
  ...
  foreach ($DATA['textures'] as $textureName => $texture) {
    ...
    $SLICES = json_decode(file_get_contents("src/sprites/textures/$textureName.json"), true);
    //copy("src/sprites/textures/$textureName.png",         "res/$textureName.png");
    //copy("src/sprites/textures/$textureName-x.png",       "res/$textureName-x.png");
    //copy("src/sprites/textures/$textureName-pink.png",    "res/$textureName-pink.png");
    //copy("src/sprites/textures/$textureName-pink-x.png",  "res/$textureName-pink-x.png");
    //copy("src/sprites/textures/$textureName-cyan.png",    "res/$textureName-cyan.png");
    //copy("src/sprites/textures/$textureName-cyan-x.png",  "res/$textureName-cyan-x.png");
    //copy("src/sprites/textures/$textureName-wacky.png",   "res/$textureName-wacky.png");
    //copy("src/sprites/textures/$textureName-wacky-x.png", "res/$textureName-wacky-x.png");
  ...
  file_put_contents('built/js/R.sprites.js', "// DO NOT EDIT THIS FILE: it is automatically generated by make/sprites.php\n\n_.extend(R, \n" . json_encode($R) . "\n);\n");
