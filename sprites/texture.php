    ...
    <li>
      <a href="<?php echo $characterName ?>/">
        ...
        <?php if ($arbitrarySlice): ?>
          <span class="imgcontainer" style="display: inline-block; margin: 2px;"><img src="<?php echo "$BASEURL/textures/$textureName/$arbitrarySlice" ?>"></span><?php echo $characterName ?>
        <?php else: ?>
