<?php
  ...
  list($textureWidth, $textureHeight) = getimagesize("../../built/spritesheets/$textureName.png");
...
<script>
var sliceImgBaseUrl = '<?php echo "$BASEURL/../../src/sprites/textures/$textureName/" ?>';
$(function() {
...
<div id="sliceDialog" title="Choose a slice" style="display: none;">
  <img src="<?php echo "$BASEURL/../../built/spritesheets/$textureName.png" ?>" id="texture">
</div>
