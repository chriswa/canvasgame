...
$BASEURL = '/dropbox/canvasgame/tools/sprites';
...
function showHeader() {
  ...
  ?>
    ...
    <link rel="stylesheet" href="<?php echo $BASEURL ?>/web/init.css" type="text/css" media="all" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
    <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.8.23/jquery-ui.min.js"></script>
    <script src="<?php echo $BASEURL ?>/web/init.js"></script>
  <?php
}
...
function loadData() {
  global $DATA;
  $DATA = json_decode(file_get_contents('../../src/sprites/animations.json'), true);
}

// 
function saveData() {
  global $DATA;
  file_put_contents('../../src/sprites/animations.json', json_encode($DATA));
}

//
function getSlices($textureName) {
  $files = glob("../../src/sprites/textures/$textureName/*");
...
// 
function packTexture($textureName, $algorithm) {
  
  $blocks = array();
  $sort = array();
  foreach (glob("../../src/sprites/textures/$textureName/*.png") as $slice) {
  ...
  if (!$blocks) { die("no slices found in ../../src/sprites/textures/$textureName/*.png"); }
  ...
  imagepng($sheetImage, "../../built/spritesheets/$textureName.png");
  ...
  file_put_contents("../../src/sprites/textures/$textureName.json", json_encode($json));
